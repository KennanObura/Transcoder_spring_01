...
public class GlobalExceptionHandler {
    ...
    public final ResponseEntity<ApiError> handleException(Exception ex, WebRequest request) {
        ...
        if (ex instanceof PathNotFoundException) {
            ...
            ProcessTerminatedException cnae = (ProcessTerminatedException) ex;
    ...
    /**
     * Customize the response for PathNotFoundException.
     *
     ...
     * @return a {@code ResponseEntity} instance
     */
    protected ResponseEntity<ApiError> handleProcessTerminatedException(
            ProcessTerminatedException ex,
            HttpHeaders headers,
            HttpStatus status,
            WebRequest request) {
